...
namespace Utils
{
    ...
    {
        private static readonly Type _injectAssetAtributeType = typeof(InjectAssetAttribute);
        ...
        public static T Inject<T>(this AssetsContext context, T target)
        {
            ...
            for(int i = 0; i < allFields.Length; i++)
            {
                ...
                var injectAssetAttribute = fieldInfo.GetCustomAttribute(_injectAssetAtributeType) as InjectAssetAttribute;
